...
@InputType()
class NotificationUpdateManyWithoutUtilisateursInput {
...
export { NotificationUpdateManyWithoutUtilisateursInput as NotificationUpdateManyWithoutUtilisateursInput };
