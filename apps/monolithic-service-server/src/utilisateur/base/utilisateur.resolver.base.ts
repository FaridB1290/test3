...
export class UtilisateurResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Commerce], { name: "commerceItems" })
  @nestAccessControl.UseRoles({
    resource: "Commerce",
    action: "read",
    possession: "any",
  ...
  async findCommerceItems(
    ...
    const results = await this.service.findCommerceItems(parent.id, args);
  ...
  async GetUtilisateurDetails(
    ...
    return this.service.GetUtilisateurDetails(args);
  }
  ...
  async GetUtilisateurs(
    ...
    return this.service.GetUtilisateurs(args);
  }
  ...
  async UpdateUtilisateurInfo(
    ...
    return this.service.UpdateUtilisateurInfo(args);
  }
}
