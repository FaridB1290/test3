...
@InputType()
class CommerceCreateNestedManyWithoutUtilisateursInput {
...
export { CommerceCreateNestedManyWithoutUtilisateursInput as CommerceCreateNestedManyWithoutUtilisateursInput };
