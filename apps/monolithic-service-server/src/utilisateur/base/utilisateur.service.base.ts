...
export class UtilisateurServiceBase {
  ...
  async findCommerceItems(
    parentId: string,
    args: Prisma.CommerceFindManyArgs
  ...
  async GetUtilisateurDetails(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async GetUtilisateurs(args: string): Promise<string[]> {
    throw new Error("Not implemented");
  }
  async UpdateUtilisateurInfo(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
}
