...
@InputType()
class FeedbackCreateNestedManyWithoutCommerceItemsInput {
...
export { FeedbackCreateNestedManyWithoutCommerceItemsInput as FeedbackCreateNestedManyWithoutCommerceItemsInput };
